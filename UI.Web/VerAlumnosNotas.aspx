...
<asp:Content ID="Content1" ContentPlaceHolderID="bodyContentPlaceHolder" runat="server">
    ...
    <asp:GridView ID="gvAlumnosCurso" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="gvAlumnosCurso_SelectedIndexChanged" Width="1533px" DataKeyNames="ID">
        <Columns>
