...
<asp:Content ID="Content1" ContentPlaceHolderID="bodyContentPlaceHolder" runat="server">
    <asp:GridView ID="gvCursosdeDocente" runat="server" Width="1517px" AutoGenerateColumns="False" EmptyDataText="No hay cursos asignados" ShowHeaderWhenEmpty="True" DataKeyNames="ID" OnSelectedIndexChanged="gvCursosdeDocente_SelectedIndexChanged">
        <Columns>
    ...
    <asp:Panel ID="Panel4" runat="server">
        <asp:Button ID="btnEditarCurso" runat="server" Text="Editar curso" OnClick="btnEditarCurso_Click" />
        &nbsp;&nbsp;&nbsp;&nbsp;
