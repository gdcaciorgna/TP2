...
<asp:Content ID="Content1" ContentPlaceHolderID="bodyContentPlaceHolder" runat="server">
    ...
    <asp:Panel ID="Panel1" runat="server">
        <asp:GridView ID="GridViewEspecialidades" runat="server" AutoGenerateColumns="False" DataKeyNames="ID" OnSelectedIndexChanged="GridViewEspecialidades_SelectedIndexChanged" CssClass="table table-striped table-bordered table-hover" EmptyDataText="Aún no hay especialidades cargadas." ShowHeaderWhenEmpty="True">
            <Columns>
