...
<asp:Content ID="Content1" ContentPlaceHolderID="bodyContentPlaceHolder" runat="server">
     ...
     <asp:Panel ID="gridPanel" runat="server">
        ...
        <asp:GridView ID="GridView" runat="server" AutoGenerateColumns="False" DataKeyNames="ID" OnSelectedIndexChanged="GridView_SelectedIndexChanged" AllowSorting="True" CssClass="table table-striped table-bordered table-hover" PageSize="6" EmptyDataText="Aún no hay alumnos cargados." ShowHeaderWhenEmpty="True">
            <Columns>
